// pages/api/nebula/get-cohort.ts
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const clientId = req.query.clientId || "634fb54c0c56610011d10202";

  try {
    const url = `${PW_NEBULA_API}/student-engagement-core/private/v1/nebula/client/${clientId}/get-cohort`;
